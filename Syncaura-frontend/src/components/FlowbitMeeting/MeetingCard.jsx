import { Video, Camera, Monitor, ArrowRight, Pencil, XCircle } from "lucide-react";
...
const MeetingCard = memo(function MeetingCard({
  ...
  const isCreator =
    currentUserId &&
    createdBy &&
    String(getId(createdBy)) === String(getId(currentUserId));
              ...
              <div className="flex items-center gap-1 mt-1">
                {canReschedule && (
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold bg-blue-100 text-blue-700 dark:bg-[#183b7a] dark:text-[#73FBFD]"
                  >
                    <Pencil size={11} />
                    Reschedule
                  </button>
                ...
                {canCancel && (
                  <button
                    ...
                    className="flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-semibold bg-red-100 text-red-600 dark:bg-[#4a2020] dark:text-red-300"
                  >
                    <XCircle size={11} />
                    Cancel
                  </button>
    ...
    <div className="flex items-center justify-end gap-2 mb-2">
      {canReschedule && (
        <button
          ...
          className="flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-700 dark:bg-[#183b7a] dark:text-[#73FBFD]"
        >
          <Pencil size={13} />
          Reschedule
        </button>
      ...
      {canCancel && (
        <button
          type="button"
          onClick={handleCancel}
          className="flex items-center gap-1 px-3 py-1.5 rounded-full text-xs font-semibold bg-red-100 text-red-600 dark:bg-[#4a2020] dark:text-red-300"
        >
          <XCircle size={13} />
          Cancel
        </button>
